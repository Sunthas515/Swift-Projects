...
//  Shared
//
//  Created by Callum McNeilage on 4/1/21.
//
...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard isOK(word: answer) else {
            wordError(title: "Word too short", message: "You think I would make it that easy?")
            return
        }
        
        guard startingWord(word: answer) else {
            wordError(title: "Cannot use the starting word", message: "Don't even think about it!")
            return
        }
